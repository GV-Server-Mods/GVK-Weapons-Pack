...
{ // Don't edit above this line
    partial class Parts
    {
        private AnimationDef AryxHydraAnims => new AnimationDef
        {
            ...
            {   //Region is used for organisation as it creates a collapsible tag.
                ...
                {
                    SubpartId = Names("rocket_1"), //Remember to remove subpart_ from these names!
                    ...
                    EventMoveSets = new Dictionary<PartAnimationSetDef.EventTriggers, RelMove[]>
                    {
                        ...
                        [Firing] =
                            new[] //Firing, Reloading, Overheated, Tracking, On, Off, BurstReload, OutOfAmmo, PreFire define a new[] for each
                            {
								...
								{
									CenterEmpty = "",
									TicksToMove = 400, //number of ticks to complete motion, 60 = 1 second
									MovementType = Delay,
									LinearPoints = new XYZ[0],
									Rotation = Transformation(0, 0, 0), //degrees
									RotAroundCenter = Transformation(0, 0, 0), //degrees
                ...
                new PartAnimationSetDef()
                {
                    SubpartId = Names("rocket_2"), //Remember to remove subpart_ from these names!
                ...
                new PartAnimationSetDef()
                {
                    SubpartId = Names("rocket_3"), //Remember to remove subpart_ from these names!
                    BarrelId = "muzzle_projectile_3", //Trigger anim when this muzzle does something.
                    StartupFireDelay = 0, //Delay in ticks until anim starts.
                    AnimationDelays = Delays(FiringDelay: 0, ReloadingDelay: 0, OverheatedDelay: 0, TrackingDelay: 0, LockedDelay: 0, OnDelay: 0, OffDelay: 0, BurstReloadDelay: 0, OutOfAmmoDelay: 0, PreFireDelay: 0),//Delay before animation starts
                    Reverse = Events(),
                    Loop = Events(), //Don't touch these.
                ...
                new PartAnimationSetDef()
                {
                    SubpartId = Names("rocket_4"), //Remember to remove subpart_ from these names!
                    BarrelId = "muzzle_projectile_4", //Trigger anim when this muzzle does something.
                    StartupFireDelay = 0, //Delay in ticks until anim starts.
                    AnimationDelays = Delays(FiringDelay: 0, ReloadingDelay: 0, OverheatedDelay: 0, TrackingDelay: 0, LockedDelay: 0, OnDelay: 0, OffDelay: 0, BurstReloadDelay: 0, OutOfAmmoDelay: 0, PreFireDelay: 0),//Delay before animation starts
                    Reverse = Events(),
                    Loop = Events(), //Don't touch these.
                ...
                new PartAnimationSetDef()
                {
                    SubpartId = Names("rocket_5"), //Remember to remove subpart_ from these names!
                    BarrelId = "muzzle_projectile_5", //Trigger anim when this muzzle does something.
                    StartupFireDelay = 0, //Delay in ticks until anim starts.
                    AnimationDelays = Delays(FiringDelay: 0, ReloadingDelay: 0, OverheatedDelay: 0, TrackingDelay: 0, LockedDelay: 0, OnDelay: 0, OffDelay: 0, BurstReloadDelay: 0, OutOfAmmoDelay: 0, PreFireDelay: 0),//Delay before animation starts
                    Reverse = Events(),
                    Loop = Events(), //Don't touch these.
                ...
                new PartAnimationSetDef()
                {
                    SubpartId = Names("rocket_6"), //Remember to remove subpart_ from these names!
                    BarrelId = "muzzle_projectile_6", //Trigger anim when this muzzle does something.
                    StartupFireDelay = 0, //Delay in ticks until anim starts.
                    AnimationDelays = Delays(FiringDelay: 0, ReloadingDelay: 0, OverheatedDelay: 0, TrackingDelay: 0, LockedDelay: 0, OnDelay: 0, OffDelay: 0, BurstReloadDelay: 0, OutOfAmmoDelay: 0, PreFireDelay: 0),//Delay before animation starts
                    Reverse = Events(),
                    Loop = Events(), //Don't touch these.
