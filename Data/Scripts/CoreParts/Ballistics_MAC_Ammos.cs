...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef LargeRailgunSabot => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            ...
            EnergyCost = 0.01071f, // comes out to 383.75MW. This is because of the bug where lasers often wouldn't actually hit and needed a fragment to hit, but if it did hit then I didnt want double damage on the MAC.
            BaseDamage = 2000000f, // Direct damage; one steel plate is worth 100.
            ...
            {
                AmmoRound = "", // AmmoRound field of the ammo to spawn. //LargeRailgunSabot_NPC_Fragment
                Fragments = 1, // Number of projectiles to spawn.
                Degrees = 0.05f, // Cone in which to randomize direction of spawned projectiles.
                ...
                TimedSpawns = new TimedSpawnDef // disables FragOnEnd in favor of info specified below, unless ArmWhenHit or Eol ArmOnlyOnHit is set to true then both kinds of frags are active
                {
                    ...
                    Proximity = 2600, // Starting distance from target bounding sphere to start spawning fragments, 0 disables this feature.  No spawning outside this distance
        ...
        private AmmoDef LargeRailgunSabot_NPC
        {
            get
            {
                var ammo = LargeRailgunSabot;
                ammo.AmmoRound = "LargeRailgunSabot_NPC";
				ammo.HybridRound = false;
				ammo.AmmoMagazine = "Energy";
				ammo.EnergyCost = 0.0001f;
				ammo.EnergyMagazineSize = 1;
				ammo.Fragment.AmmoRound = "LargeRailgunSabot_NPC_Fragment";
