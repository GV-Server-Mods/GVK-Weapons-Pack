...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef Lasers_Plasma => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            ...
            EnergyCost = 9.4f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            ...
            Fragment = new FragmentDef {
                AmmoRound = "Lasers_Plasma_Shrapnel", // AmmoRound field of the ammo to spawn.
