...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef lokiCannon1beam => new AmmoDef
        {
            AmmoMagazine = "Energy",
            AmmoRound = "lokiBeam",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
            EnergyCost = 60000f, //(((EnergyCost * DefaultDamage) * ShotsPerSecond) * BarrelsPerShot) * ShotsPerBarrel
            BaseDamage = 1f, //5400 per pulse muzzled
            Mass = 0, // in kilograms
            Health = 0, // 0 = disabled, otherwise how much damage it can take from other trajectiles before dying.
            BackKickForce = 0f,
            DecayPerShot = 0,
            HardPointUsable = true, // set to false if this is a shrapnel ammoType and you don't want the turret to be able to select it directly.
            EnergyMagazineSize = 180,
            ...
            AreaEffect = new AreaDamageDef
            {
                ...
                AreaEffectDamage = 50000f, // 0 = use spillover from BaseDamage, otherwise use this value.
                AreaEffectRadius = 3f,
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Particles = new AmmoParticleDef
                {
                    ...
                    Hit = new ParticleDef
                    {
                        ...
                        ApplyToShield = true,
                        ShrinkByDistance = false,
                        Color = Color(red: 0, green: 155, blue: 100, alpha: 1),
                        Offset = Vector(x: 0, y: 0, z: 0),
                        Extras = new ParticleOptionDef
                        {
                            Restart = false,
