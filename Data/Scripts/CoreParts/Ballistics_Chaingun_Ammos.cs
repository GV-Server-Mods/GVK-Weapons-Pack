...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef AutocannonClip => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            ...
            {
                AmmoRound = "", //AutocannonClip_Ricochet // AmmoRound field of the ammo to spawn.
                ...
                Radial = 25f, // Determines starting angle for Degrees of spread above.  IE, 0 degrees and 90 radial goes perpendicular to travel path
        ...
        private AmmoDef AutocannonClip_Ricochet => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "AutocannonClip_Ricochet", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.1f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 0.01f, // Direct damage; one steel plate is worth 100.
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                DeaccelTime = 0, // 0 is disabled, a value causes the projectile to come to rest overtime, (Measured in game ticks, 60 = 1 second)
                GravityMultiplier = 0f, // Gravity multiplier, influences the trajectory of the projectile, value greater than 0 to enable. Natural Gravity Only.
                SpeedVariance = Random(start: 100, end: 400), // subtracts value from DesiredSpeed. Be warned, you can make your projectile go backwards.
