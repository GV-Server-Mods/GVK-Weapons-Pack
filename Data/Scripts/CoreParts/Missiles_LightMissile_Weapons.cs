...
namespace Scripts
{
    partial class Parts
    {
        WeaponDefinition LightMissileTurret => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] 
				{
                    new MountPointDef 
					{
                        SubtypeId = "GVK_LightMissileTurret",
            ...
            {
                PartName = "Zenith Missile", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                DeviateShotAngle = 0.2f, // Projectile inaccuracy in degrees.
                AimingTolerance = 179, // How many degrees off target a turret can fire at. 0 - 180 firing angle.
                ...
                {
                    RateOfFire = 240, // 240. Set this to 3600 for beam weapons.
                    ...
                    DelayAfterBurst = 120, // 160. How long to spend "reloading" after each burst. Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
