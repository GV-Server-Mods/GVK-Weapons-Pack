...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef Ballistics_HeavyCannon => new AmmoDef
        {
            ...
            BaseDamage = 10000f, // breaks 1 HA or 1 LA cubes in 1 round
			...
			AreaOfDamage = new AreaOfDamageDef {
                ...
                EndOfLife = new EndOfLifeDef
                {
                    ...
                    NoSound = false,
                    ParticleScale = 1,
                    CustomParticle = "Explosion_AmmunitionLarge", //Explosion_AmmunitionLarge, MD_FlakExplosion
            ...
            Trajectory = new TrajectoryDef {
                ...
                AccelPerSec = 0f,
                DesiredSpeed = 400f, // DO NOT SET HIGHER THAN 4100
                MaxTrajectory = 3300f,
