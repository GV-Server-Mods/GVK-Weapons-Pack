...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition lokiCannon1_def => new WeaponDefinition
        {
            ...
            {
                PartName = "HPA-500 Heavy Particle Accelerator LOKI", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
