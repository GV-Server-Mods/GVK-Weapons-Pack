...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef Lasers_Laser_Small => new AmmoDef //Blue Receptor laser
        {
            ...
            EnergyCost = 7.5f, //(((EnergyCost * DefaultDamage) * ShotsPerSecond) * BarrelsPerShot) * ShotsPerBarrel    (15 * 0.05 * 3600/60/60 = 0.75MW per tick)
            BaseDamage = 1f,
        ...
        private AmmoDef Lasers_Laser_Large => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            ...
            EnergyCost = 30.0f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 10f, //
                        Width = 0.4f, //
                        Color = Color(red: 10, green: 1, blue: 0f, alpha: 1), // RBG 255 is Neon Glowing, 100 is Quite Bright.
                        VisualFadeStart = 0, // Number of ticks the weapon has been firing before projectiles begin to fade their color
                        VisualFadeEnd = 0, // How many ticks after fade began before it will be invisible.
                        Textures = new[] {// WeaponLaser, ProjectileTrailLine, WarpBubble, etc..
        ...
        private AmmoDef Lasers_Laser_Large_Shrapnel => new AmmoDef //Blue Receptor laser
        {
            AmmoMagazine = "Energy",
        ...
        private AmmoDef Lasers_Laser_Small_Shrapnel => new AmmoDef //Blue Receptor laser
        {
            AmmoMagazine = "Energy",
