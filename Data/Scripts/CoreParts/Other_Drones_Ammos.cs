...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef Others_Drone_Offense => new AmmoDef
        {
            AmmoMagazine = "Others_Drone_Falcon",
            AmmoRound = "Falcon Offense Mode", 
            BaseDamage = 1f,
            ...
            {
                AmmoRound = "AutocannonClip_Drone", // AmmoRound field of the ammo to spawn.
                ...
                TimedSpawns = new TimedSpawnDef // disables FragOnEnd in favor of info specified below
                {
                    ...
                    GroupDelay = 90, // Delay between each group.
                },
            },
        ...
        private AmmoDef Others_Drone_Defense => new AmmoDef
        {
            AmmoMagazine = "Others_Drone_Falcon",
            AmmoRound = "Falcon Defense Mode", 
            BaseDamage = 1f,
            Mass = 1000f, // in kilograms
            Health = 200f, // 0 = disabled, otherwise how much damage it can take from other trajectiles before dying.
            BackKickForce = 5f,
