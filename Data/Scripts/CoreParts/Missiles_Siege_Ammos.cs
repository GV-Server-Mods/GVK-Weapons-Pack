...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef Missiles_Siege_Test => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "Missiles_Siege", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Missiles_Siege_Test", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            {
                AmmoRound = "Missiles_Siege_Test_Shrapnel", // AmmoRound field of the ammo to spawn.
                ...
                TimedSpawns = new TimedSpawnDef // disables FragOnEnd in favor of info specified below
                {
                    ...
                    GroupDelay = 999, // Delay between each group.
                },
            },
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                TargetLossDegree = 80, // Degrees, Is pointed forward
                ...
                Smarts = new SmartsDef
                {
                    ...
                    MaxLateralThrust = 0.000001f, // controls how sharp the trajectile may turn between 0.000001, 1
                    TrackingDelay = 420, // Measured in Shape diameter units traveled.
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Particles = new AmmoParticleDef
                {
                    ...
                    {
                        Name = "Archer_MissileSmokeTrail", //ShipWelderArc  Smoke_Missile
        ...
        private AmmoDef Missiles_Siege_Test_Shrapnel => new AmmoDef
        {
            AmmoMagazine = "Energy",
            AmmoRound = "Missiles_Siege_Test_Shrapnel",
            ...
            AreaOfDamage = new AreaOfDamageDef
            {
                ...
                EndOfLife = new EndOfLifeDef
                {
                    ...
                    NoSound = true,
                    ParticleScale = 1,
                    CustomParticle = "Collision_Sparks", // Particle SubtypeID, from your Particle SBC
                    CustomSound = "", // SubtypeID from your Audio SBC, not a filename
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                TargetLossDegree = 90, // Degrees, Is pointed forward
                ...
                RangeVariance = Random(start: 200, end: 0), // subtracts value from MaxTrajectory
                MaxTrajectoryTime = 0, // How long the weapon must fire before it reaches MaxTrajectory.
                Smarts = new SmartsDef
                {
                    Inaccuracy = 0f, // 0 is perfect, hit accuracy will be a random num of meters between 0 and this value.
                    Aggressiveness = 1f, // controls how responsive tracking is.
                    MaxLateralThrust = 0.1f, // controls how sharp the trajectile may turn between 0.000001, 1
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 10f, //
                        Width = 1f, //
                        Color = Color(red: 50, green: 25, blue: 1f, alpha: 1), // RBG 255 is Neon Glowing, 100 is Quite Bright.
                        VisualFadeStart = 0, // Number of ticks the weapon has been firing before projectiles begin to fade their color
                        VisualFadeEnd = 0, // How many ticks after fade began before it will be invisible.
                        Textures = new[] {// WeaponLaser, ProjectileTrailLine, WarpBubble, etc..
                            "WeaponLaser", // Please always have this Line set, if this Section is enabled.
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        Color = Color(red: 10, green: 10, blue: 5f, alpha: 1), // RBG 255 is Neon Glowing, 100 is Quite Bright.
                        Back = false,
                        CustomWidth = 0,
                        UseWidthVariance = true,
                        UseColorFade = true,
        ...
        private AmmoDef Missiles_Siege_Test2 => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "Missiles_Siege", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Missiles_Siege_Test2", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.1f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 1f, // Direct damage; one steel plate is worth 100.
            Mass = 45f, // In kilograms; how much force the impact will apply to the target.
            ...
            Fragment = new FragmentDef // Formerly known as Shrapnel. Spawns specified ammo fragments on projectile death (via hit or detonation).
            {
                AmmoRound = "Missiles_Siege_Test_Shrapnel2", // AmmoRound field of the ammo to spawn.
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                Smarts = new SmartsDef
                {
                    Inaccuracy = 0f, // 0 is perfect, hit accuracy will be a random num of meters between 0 and this value.
                    Aggressiveness = 1f, // controls how responsive tracking is.
                    MaxLateralThrust = 0.000001, // controls how sharp the trajectile may turn between 0.000001, 1
        ...
        private AmmoDef Missiles_Siege_Test_Shrapnel2 => new AmmoDef
        {
            AmmoMagazine = "Energy",
            AmmoRound = "Missiles_Siege_Test_Shrapnel2",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
            EnergyCost = 0f, //(((EnergyCost * DefaultDamage) * ShotsPerSecond) * BarrelsPerShot) * ShotsPerBarrel
            BaseDamage = 1000f,
            Mass = 0, // in kilograms
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                TargetLossDegree = 30, // Degrees, Is pointed forward
                TargetLossTime = 0, // 0 is disabled, Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                MaxLifeTime = 400, // 0 is disabled, Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..). time begins at 0 and time must EXCEED this value to trigger "time > maxValue". Please have a value for this, It stops Bad things.
                ...
                Smarts = new SmartsDef
                {
                    ...
                    OffsetTime = 999, // how often to offset degree, measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..)
                },
			},
            AmmoGraphics = new GraphicDef
            {
                ...
                Particles = new AmmoParticleDef
                {
                    ...
                    Hit = new ParticleDef
                    {
                        Name = "", //MD_HydraRocketExplosion Explosion_AmmunitionSmall
                        ApplyToShield = true,
                        ShrinkByDistance = false,
                        Color = Color(red: 1, green: 1, blue: 1, alpha: 1),
                        Offset = Vector(x: 0, y: 0, z: 0),
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 5f, //
                        Width = 1f, //
                        Color = Color(red: 40, green: 20, blue: 1f, alpha: 1), // RBG 255 is Neon Glowing, 100 is Quite Bright.
                        VisualFadeStart = 0, // Number of ticks the weapon has been firing before projectiles begin to fade their color
                        VisualFadeEnd = 0, // How many ticks after fade began before it will be invisible.
                        Textures = new[] {// WeaponLaser, ProjectileTrailLine, WarpBubble, etc..
