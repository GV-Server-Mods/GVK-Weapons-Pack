...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition Other_Warheads_RegularWarhead_LG_Weapon => new WeaponDefinition
        {
            ...
            {
                PartName = "Warhead", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                HardWare = new HardwareDef
                {
                    ...
                    CriticalReaction = new CriticalDef
                    {
                        ...
                        DefaultArmedTimer = 10, // Sets default countdown duration.
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "HWR_LargeExplosion", // Audio for firing.
            ...
            Ammos = new[] {
				...
				Other_Warheads_RegularWarhead_LG_Shrapnel,
            },
        ...
        WeaponDefinition Other_Warheads_RegularWarhead_SG_Weapon => new WeaponDefinition
        {
            ...
            HardPoint = new HardPointDef
            {
                ...
                {
                    PreFiringSound = "", // Audio for warmup effect.
                    FiringSound = "HWR_SmallExplosion", // Audio for firing.
                    FiringSoundPerShot = true, // Whether to replay the sound for each shot, or just loop over the entire track while firing.
                    ReloadSound = "", // Sound SubtypeID, for when your Weapon is in a reloading state
                    NoAmmoSound = "",
                    HardPointRotationSound = "", // Audio played when turret is moving.
            ...
            Ammos = new[] {
				...
				Other_Warheads_RegularWarhead_SG_Shrapnel, // Must list all primary, shrapnel, and pattern ammos.
            },
            //Animations = Weapon75_Animation,
            //Upgrades = UpgradeModules,
        };
