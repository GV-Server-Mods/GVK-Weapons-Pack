...
namespace Scripts {   
    partial class Parts {
		...
		private LoadingDef Other_Warheads_Loading = new LoadingDef
		{
		...
		private OtherDef Other_Warheads_Other => new OtherDef
		{
			ConstructPartCap = 50, // Maximum number of blocks with this weapon on a grid; 0 = unlimited.
        ...
        WeaponDefinition Other_Warheads_RegularWarhead_LG_Weapon => new WeaponDefinition
        {
            ...
            HardPoint = new HardPointDef
            {
                ...
                Other = Other_Warheads_Other,
                Loading = Other_Warheads_Loading,
            },
            Ammos = new[] {
        ...
        WeaponDefinition Other_Warheads_RegularWarhead_SG_Weapon => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] 
            ...
            HardPoint = new HardPointDef
            {
                PartName = "Small Warhead", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                AimLeadingPrediction = Off, // Level of turret aim prediction; Off, Basic, Accurate, Advanced
                NpcSafe = true, // This is you tell npc moders that your ammo was designed with them in mind, if they tell you otherwise set this to false.
                ScanTrackOnly = true, // This weapon only scans and tracks entities, this disables un-needed functionality and customizes for this purpose. 
                Ui = Common_Weapons_Hardpoint_Ui_FullDisable,
                ...
                HardWare = new HardwareDef
                {
                    ...
                    CriticalReaction = new CriticalDef
                    {
                        ...
                        PreArmed = false, // Whether the warhead is armed by default when placed. Best left as false.
                        TerminalControls = true, // Whether the warhead should have terminal controls for arming and detonation.
                        AmmoRound = "Other_Warheads_RegularWarhead_SG_Ammo", // Optional. If specified, the warhead will always use this ammo on detonation rather than the currently selected ammo.
                    },
                },
                Other = Other_Warheads_Other,
                Loading = Other_Warheads_Loading,
