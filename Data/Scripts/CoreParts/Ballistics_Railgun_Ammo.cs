...
{ // Don't edit above this line
    partial class Parts
    {
        ...
        private AmmoDef SmallRailgunAmmo_Pen => new AmmoDef
        {
            ...
            {
                AmmoRound = "Railgun Pen Frag", // AmmoRound field of the ammo to spawn.
                Fragments = 1, // Number of projectiles to spawn.
                Degrees = 10, // Cone in which to randomize direction of spawned projectiles.
                Reverse = false, // Spawn projectiles backward instead of forward.
                DropVelocity = true, // fragments will not inherit velocity from parent.
                Offset = 2.4f, // Offsets the fragment spawn by this amount, in meters (positive forward, negative for backwards), value is read from parent ammo type.
        ...
        private AmmoDef SmallRailgunAmmo_Pen_Fragment => new AmmoDef
        {
            AmmoMagazine = "Energy",
            AmmoRound = "Railgun Pen Frag",
