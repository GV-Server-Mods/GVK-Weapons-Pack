...
{ // Don't edit above this line
    partial class Parts
    {
        ...
        private AmmoDef SmallRailgunAmmo_NPC => new AmmoDef
        {
            AmmoMagazine = "SmallRailgunAmmo",
            AmmoRound = "SmallRailgunAmmo",
            HybridRound = true, //AmmoMagazine based weapon with energy cost
            ...
            {
                AmmoRound = "SmallRailgunAmmo_NPC_Fragment1", // AmmoRound field of the ammo to spawn.
                Fragments = 1, // Number of projectiles to spawn.
                Degrees = 0.01f, // Cone in which to randomize direction of spawned projectiles.
                ...
                TimedSpawns = new TimedSpawnDef // disables FragOnEnd in favor of info specified below, unless ArmWhenHit or Eol ArmOnlyOnHit is set to true then both kinds of frags are active
                {
                    ...
                    Proximity = 3300, // Starting distance from target bounding sphere to start spawning fragments, 0 disables this feature.  No spawning outside this distance
            ...
            Trajectory = new TrajectoryDef 
			{
                ...
                DesiredSpeed = 3000, // DO NOT SET HIGHER THAN 4100
                MaxTrajectory = 3300,
        ...
        private AmmoDef SmallRailgunAmmo_NPC_Fragment1
        {
            get
            {
                var ammo = SmallRailgunAmmo;
                ammo.AmmoRound = "SmallRailgunAmmo_NPC_Fragment1";
