...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition BasicHandHeldLauncherGun => new WeaponDefinition
        {
            ...
            {
                PartName = "Basic Rocket", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
		...
		WeaponDefinition AdvancedHandHeldLauncherGun => new WeaponDefinition
        {
            ...
            HardPoint = new HardPointDef
            {
                PartName = "Advanced Rocket", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                DeviateShotAngle = 3f, // Projectile inaccuracy in degrees.
                AimingTolerance = 0f, // How many degrees off target a turret can fire at. 0 - 180 firing angle.
                AimLeadingPrediction = Off, // Level of turret aim prediction; Off, Basic, Accurate, Advanced
                DelayCeaseFire = 0, // Measured in game ticks (6 = 100ms, 60 = 1 second, etc..). Length of time the weapon continues firing after trigger is released - while a target is available.
            ...
            Ammos = new[] {
                Advanced_Rocket_Launch, Advanced_Rocket, Rocket_Frag, 
            },
            //Animations = Weapon75_Animation,
            //Upgrades = UpgradeModules,
        };
