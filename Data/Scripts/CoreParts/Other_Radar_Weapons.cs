...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition AryxRadar => new WeaponDefinition {
            ...
            {
                PartName = "Large Aegis System", // name of weapon in terminal
                DeviateShotAngle = 0,
...
/*        WeaponDefinition SmallDesignator => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
            ...
            Targeting = new TargetingDef
            {
                ...
                SubSystems = new[] {
                    Power, Any, // Subsystem targeting priority: Offense, Utility, Power, Production, Thrust, Jumping, Steering, Any
                },
            ...
            HardPoint = new HardPointDef
            {
                PartName = "Designator Unit", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Loading = new LoadingDef
                {
                    ...
                    FireFullBurst = false, // Whether the weapon should fire the full burst, even if the target is lost or player stops firing prematurely.
                    GiveUpAfterBurst = false, // Whether the weapon should drop its current target and reacquire a new target after finishing its burst.
                    BarrelSpinRate = 0, // Visual only, 0 disables and uses RateOfFire.
                    DeterministicSpin = false, // Spin barrel position will always be relative to initial / starting positions (spin will not be as smooth).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "OKI_Observer_Large_Turret_Audio", // Audio for firing.
            ...
            Ammos = new[] {
                AmmoDesignator, // Must list all primary, shrapnel, and pattern ammos.
            },
