...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef Other_Warheads_RegularWarhead_LG_Ammo => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            ...
            AmmoRound = "Other_Warheads_RegularWarhead_LG_Ammo", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            ...
            {
                AmmoRound = "Other_Warheads_RegularWarhead_LG_Shrapnel", // AmmoRound field of the ammo to spawn.
                ...
                MaxChildren = 50, // number of maximum branches for fragments from the roots point of view, 0 is unlimited
            ...
            AreaOfDamage = new AreaOfDamageDef
            {
                ...
                EndOfLife = new EndOfLifeDef
                {
                    ...
                    NoSound = false,
                    ParticleScale = 1,
                    CustomParticle = "MD_HydraRocketExplosion",
                    CustomSound = "HWR_LargeExplosion",
                    Shape = Diamond, // Round or Diamond shape.  Diamond is more performance friendly.
                }, 
            },
            Ewar = new EwarDef
            ...
            AmmoAudio = new AmmoAudioDef
            {
                ...
                ShotSound = "",
                ShieldHitSound = "HWR_FireyExplosion",
                PlayerHitSound = "HWR_FireyExplosion",
                VoxelHitSound = "HWR_FireyExplosion",
                FloatingHitSound = "HWR_FireyExplosion",
                HitPlayChance = 1f,
                HitPlayShield = true,
            },
        ...
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Other_Warheads_RegularWarhead_SG_Ammo", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.00000000001f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 1f, // Direct damage; one steel plate is worth 100.
            Mass = 1f, // In kilograms; how much force the impact will apply to the target.
            ...
            Fragment = new FragmentDef // Formerly known as Shrapnel. Spawns specified ammo fragments on projectile death (via hit or detonation).
            {
                AmmoRound = "Other_Warheads_RegularWarhead_SG_Shrapnel", // AmmoRound field of the ammo to spawn.
            ...
            AmmoAudio = new AmmoAudioDef
            {
                ...
                ShotSound = "",
                ShieldHitSound = "HWR_LargeExplosion",
                PlayerHitSound = "HWR_LargeExplosion",
                VoxelHitSound = "HWR_LargeExplosion",
                FloatingHitSound = "HWR_LargeExplosion",
                HitPlayChance = 1f,
                HitPlayShield = true,
            },
            Ejection = new EjectionDef // Optional Component, allows generation of Particle or Item (Typically magazine), on firing, to simulate Tank shell ejection
        ...
        private AmmoDef Other_Warheads_RegularWarhead_LG_Shrapnel => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Other_Warheads_RegularWarhead_LG_Shrapnel", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.00000000001f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 1f, // Direct damage; one steel plate is worth 100.
            Mass = 1f, // In kilograms; how much force the impact will apply to the target.
            ...
            AreaOfDamage = new AreaOfDamageDef
            {
                ...
                EndOfLife = new EndOfLifeDef
                {
                    ...
                    NoSound = true,
                    ParticleScale = 1,
                    CustomParticle = "", // // if left blank it defaults to some smokey explosion
                    CustomSound = "",
                    Shape = Diamond, // Round or Diamond shape.  Diamond is more performance friendly.
                }, 
            },
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                RangeVariance = Random(start: 10, end: 0), // subtracts value from MaxTrajectory
                MaxTrajectoryTime = 0, // How long the weapon must fire before it reaches MaxTrajectory.
                Smarts = new SmartsDef
                {
                    Inaccuracy = 0f, // 0 is perfect, hit accuracy will be a random num of meters between 0 and this value.
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 5f, //
                        Width = 0.1f, //
                        Color = Color(red: 10, green: 5, blue: 2f, alpha: 1), // RBG 255 is Neon Glowing, 100 is Quite Bright.
                        VisualFadeStart = 0, // Number of ticks the weapon has been firing before projectiles begin to fade their color
                        VisualFadeEnd = 0, // How many ticks after fade began before it will be invisible.
                        Textures = new[] {// WeaponLaser, ProjectileTrailLine, WarpBubble, etc..
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        Color = Color(red: 10, green: 2, blue: 1, alpha: 1),
                        Back = false,
                        CustomWidth = 1,
                        UseWidthVariance = false,
                        UseColorFade = false,
        ...
        private AmmoDef Other_Warheads_RegularWarhead_SG_Shrapnel => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Other_Warheads_RegularWarhead_SG_Shrapnel", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.00000000001f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 1f, // Direct damage; one steel plate is worth 100.
            Mass = 1f, // In kilograms; how much force the impact will apply to the target.
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                MaxTrajectory = 5, // Max Distance the projectile or beam can Travel.
                DeaccelTime = 0, // 0 is disabled, a value causes the projectile to come to rest overtime, (Measured in game ticks, 60 = 1 second)
                GravityMultiplier = 0f, // Gravity multiplier, influences the trajectory of the projectile, value greater than 0 to enable. Natural Gravity Only.
                SpeedVariance = Random(start: 10, end: 0), // subtracts value from DesiredSpeed. Be warned, you can make your projectile go backwards.
                RangeVariance = Random(start: 2, end: 0), // subtracts value from MaxTrajectory
                MaxTrajectoryTime = 0, // How long the weapon must fire before it reaches MaxTrajectory.
                Smarts = new SmartsDef
                {
                    Inaccuracy = 0f, // 0 is perfect, hit accuracy will be a random num of meters between 0 and this value.
